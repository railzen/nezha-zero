...
```
curl -L https://raw.githubusercontent.com/railzen/nezha-zero/main/script/naza.sh -o nezha.sh && chmod +x nezha.sh && sudo ./nezha.sh install_agent nezha.seales.nom.za 443 eAxO9IF519fKFODlW0 --tls
```
